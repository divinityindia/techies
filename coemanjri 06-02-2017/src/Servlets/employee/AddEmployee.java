		...
		if(session.getAttribute("cat")!=null)
		{
			if(session.getAttribute("cat").equals("Administrator")&&bean.isAddemployee())
			{
		        ...
		        while (iterator.hasNext()) {
		            ...
		            Employee eBean=new Employee(sal, fname, mname, lname, photo, bcud, panno, aadharno, paddress, caddress, pstate, cstate, pcity, ccity, ppin, cpin, dateofbirth, gender, religion, category, caste, mstatus, mobile, email, website, branchId, post, dateofjoining, noa, noj);
