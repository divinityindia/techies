 ...
 */
public class UpdateEmployeeExp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UpdateEmployeeExp() {
        super();
		...
		if(session.getAttribute("cat")!=null)
		{
			...
			{	
	            ...
	            int result=EmployeeDao.addExp(empExp);
					...
					response.sendRedirect("updateemployee?expsuccess="+expsuccess+"&action=3&employeeid="+fid);
			}
