...
public class Employee {
	 ...
	 public String getBcud() {
		return bcud;
	}


	public void setBcud(String bcud) {
		this.bcud = bcud;
	}


	public Employee(int facultyId, String headline, String krCategory, String publication, String author, Date date,
			String url, InputStream article, String documentName, String documentType, long documentLength,
			String keywords, String content, String notes, String priority, String guide, String coguide,
			String teamsize) {
		super();
	...
	public Employee(int facultyId, String sal,String fname, String mname, String lname, String bcud, String panno, String aadharno,
	...
	public Employee(int facultyId, String sal,String fname, String mname, String lname, String email, String branchName) {
		super();
		this.facultyId = facultyId;
		this.sal=sal;
		this.fname = fname;
	...
	public Employee(String sal, String fname, String mname, String lname, InputStream photo, String bcud, String panno,
	...
	public Employee(int facultyId, String sal, String fname, String mname, String lname, InputStream photo,
			String bcud, String panno, String aadharno, String paddress, String caddress, String pstate, String state, String pcity,
			String city, String ppin, String cpin, Date dob, String gender, String religion, String category,
			String caste, String mstatus, String mobile, String email, String website, int branchId, String post,
			Date doj, String noa, String noj) {
		super();
		this.facultyId = facultyId;
		this.sal = sal;
		this.fname = fname;
	...
	public Employee(int facultyId, String sal, String fname, String mname, String lname, InputStream photo,
			String panno, String aadharno, String paddress, String caddress, String pstate, String state, String pcity,
			String city, String ppin, String cpin, Date dob, String gender, String religion, String category,
			String caste, String mstatus, String mobile, String email, String website, int branchId, String post,
			Date doj, String noa, String noj, String eorg, String eurl, String designation, String jobprofile,
			Date fromDate, Date toDate, String achievement) {
		super();
		this.facultyId = facultyId;
		this.sal = sal;
		this.fname = fname;
