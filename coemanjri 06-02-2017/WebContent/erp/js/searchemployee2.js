$(document).ready(function(){
	...
	$("#searchbtn").click(function(){
		...
		if($("#chkname").is(':checked'))
		{
			...
			{
				$('#success').empty();
				$("#success").append("Please enter name.");
			...
			else
			{
				...
				$.ajax({
	                ...
	                url: "getemployee",                
	                dataType: "json",
	                data: {"fname":fname, "mname" : mname,"lname" : lname,"by":"name"},
	                success:function(data){
	                	...
	                	if(data!=''){
		                    ...
		                    var dateofbirth=new Date(item.dob);
		                    var dob= dateofbirth.getDate() + '/' + (dateofbirth.getMonth() + 1) +  '/' +  dateofbirth.getFullYear();
		                   
		                    var dateofjoining=new Date(item.doj);
		                    var doj=dateofjoining.getDate() + '/' + (dateofjoining.getMonth() + 1) +  '/' +  dateofjoining.getFullYear();
		                    var fd=new Date(item.fromDate);
		                    var fromdate=fd.getDate() + '/' + (fd.getMonth() + 1) +  '/' +  fd.getFullYear();
		                    var td=new Date(item.toDate);
		                    var todate=td.getDate() + '/' + (td.getMonth() + 1) +  '/' +  td.getFullYear();
		                    
		                    $("#studentprofile").append('<tr id="srow'+item.facultyId+'"><td class="photo"><img src="employeephotoservlet?employeeid='+item.facultyId+'"></td><td colspan="4" class="otherdetails"><p class="sname"><a href="javascript:;" class="profile" p1="'+item.facultyId+'" p2="'+item.fname+'" p3="'+item.mname+'" p4="'+item.lname+'" p5="'+item.panno+'" p6="'+item.aadharno+'" p7="'+item.paddress+'" p8="'+item.caddress+'" p9="'+item.pstate+'" p10="'+item.state+'" p11="'+item.pcity+'" p12="'+item.city+'" p13="'+item.ppin+'" p14="'+item.cpin+'" p15="'+dob+'" p16="'+item.gender+'" p17="'+item.religion+'" p18="'+item.category+'" p19="'+item.caste+'" p20="'+item.mstatus+'" p21="'+item.mobile+'" p22="'+item.email+'" p23="'+item.website+'" p24="'+item.branchName+'" p25="'+item.post+'" p26="'+doj+'" p27="'+item.noa+'" p28="'+item.noj+'" p29="'+item.eorg+'" p30="'+item.eurl+'" p31="'+item.designation+'" p32="'+item.jobprofile+'" p33="'+fromdate+'" p34="'+todate+'" p35="'+item.achievement+'" p36="'+item.sal+'">Name: '+item.sal+' '+item.fname+' '+item.mname+' '+item.lname+'</a></p><p class="sother">Branch: '+item.branchName+'</p><p class="sother">Post: '+item.post+'&emsp;Date of Joining: '+doj+'</p><p class="sother">Nature of Joining: '+item.noj+'&emsp;Nature of Appintment : '+item.noa+'</p></td></tr>');
	                		});
	                	}
	                	else
	                	{
		...
		else
		{
			...
			{
				$('#success').empty();
			    $("#success").append("Please select branch");
			    $("#success").css('display','block')
			}
			else
			{
				...
				$.ajax({
	                ...
	                success:function(data){
	                	...
	                	if(data!=''){
		                    ...
		                    $("#studentprofile").append('<tr id="srow'+item.facultyId+'"><td class="photo"><img src="employeephotoservlet?employeeid='+item.facultyId+'"></td><td colspan="4" class="otherdetails"><p class="sname"><a href="javascript:;" class="profile" p1="'+item.facultyId+'" p2="'+item.fname+'" p3="'+item.mname+'" p4="'+item.lname+'" p5="'+item.panno+'" p6="'+item.aadharno+'" p7="'+item.paddress+'" p8="'+item.caddress+'" p9="'+item.pstate+'" p10="'+item.state+'" p11="'+item.pcity+'" p12="'+item.city+'" p13="'+item.ppin+'" p14="'+item.cpin+'" p15="'+dob+'" p16="'+item.gender+'" p17="'+item.religion+'" p18="'+item.category+'" p19="'+item.caste+'" p20="'+item.mstatus+'" p21="'+item.mobile+'" p22="'+item.email+'" p23="'+item.website+'" p24="'+item.branchName+'" p25="'+item.post+'" p26="'+doj+'" p27="'+item.noa+'" p28="'+item.noj+'" p29="'+item.sal+'">Name: '+item.sal+' '+item.fname+' '+item.mname+' '+item.lname+'</a></p><p class="sother">Branch: '+item.branchName+'</p><p class="sother">Post: '+item.post+'&emsp;Date of Joining: '+doj+'</p><p class="sother">Nature of Joining: '+item.noj+'&emsp;Nature of Appintment : '+item.noa+'</p></td></tr>');
	                		});
	                	}
	                	else
	                	{
	...
	$("#studentprofile").on("click", ".profile", function(e) {
		var $this = $(this);
        var employeeid= $this.attr('p1');
        var fname= $this.attr('p2');
        var mname= $this.attr('p3');
        var lname= $this.attr('p4');
        var panno= $this.attr('p5'); 
        var aadharno= $this.attr('p6');
        var paddress= $this.attr('p7');
        var caddress= $this.attr('p8');
        var pstate= $this.attr('p9');
        var cstate= $this.attr('p10');
        var pcity= $this.attr('p11');
        var ccity= $this.attr('p12');
        var ppin= $this.attr('p13');
        var cpin= $this.attr('p14');
        var dob= $this.attr('p15');
        var gender= $this.attr('p16');
        var religion= $this.attr('p17');
        var category= $this.attr('p18');
        var caste= $this.attr('p19');
        var mstatus= $this.attr('p20');
        var mobile= $this.attr('p21');
        var email= $this.attr('p22');
        var website= $this.attr('p23');
        var branchname= $this.attr('p24');
        var post= $this.attr('p25');
        var doj= $this.attr('p26');
        var noa= $this.attr('p27');
        var noj= $this.attr('p28');
        var sal=$this.attr('p29');
        
        $(document.getElementById("srow"+employeeid+"a")).remove();
        $(document.getElementById("srow"+employeeid+"b")).remove();
        $(document.getElementById("srow"+employeeid+"c")).remove();
        $(document.getElementById("srow"+employeeid+"d")).remove();
        $(document.getElementById("srow"+employeeid+"e")).remove();
        $(document.getElementById("srow"+employeeid+"f")).remove();
        $('<tr id="srow'+employeeid+'a"><td></td><td class="otherdetails"><h4>Employee Id</h4> '+employeeid+'</td><td class="otherdetails"><h4>PAN No</h4> '+panno+'</td><td class="otherdetails"><h4>Aadhar No</h4> '+aadharno+'</td><td class="otherdetails"><h4>Gender</h4> '+gender+'</td></tr>').insertAfter(document.getElementById("srow"+employeeid));
        $('<tr id="srow'+employeeid+'b"><td></td><td class="otherdetails"><h4>Date of Birth</h4> '+dob+'</td><td class="otherdetails"><h4>Religion</h4> '+religion+'</td><td class="otherdetails"><h4>Category</h4> '+category+'</td><td class="otherdetails"><h4>Caste</h4> '+caste+'</td></tr>').insertAfter(document.getElementById("srow"+employeeid+"a"));
        $('<tr id="srow'+employeeid+'c"><td></td><td class="otherdetails"><h4>Email ID</h4> '+email+'</td><td class="otherdetails"><h4>Mobile: </h4>'+mobile+'</td><td class="otherdetails"><h4>Current Address</h4> '+caddress+'<br>City: '+ccity+'<br>State: '+cstate+'<br>Pin: '+cpin+'</td><td class="otherdetails"><h4>Permanent Address</h4> '+paddress+'<br>City: '+pcity+'<br>State: '+pstate+'<br>Pin: '+ppin+'</td></tr>').insertAfter(document.getElementById("srow"+employeeid+"b"));
        $('<tr id="srow'+employeeid+'d"><td></td><td class="otherdetails"><h4>Marital Status</h4> '+mstatus+'</td><td class="otherdetails"></td><td class="otherdetails"></td><td class="otherdetails"></td></tr>').insertAfter(document.getElementById("srow"+employeeid+"c"));
        $('<tr id="srow'+employeeid+'e"><td></td><td></td><td></td><td></td><td class="btn"><a href="editemployee.jsp?employeeid='+employeeid+'&sal='+sal+'&fname='+fname+'&mname='+mname+'&lname='+lname+'&panno='+panno+'&aadharno='+aadharno+'&paddress='+paddress+'&caddress='+caddress+'&pstate='+pstate+'&cstate='+cstate+'&pcity='+pcity+'&ccity='+ccity+'&ppin='+ppin+'&cpin='+cpin+'&dob='+dob+'&gender='+gender+'&religion='+religion+'&category='+category+'&caste='+caste+'&mstatus='+mstatus+'&mobile='+mobile+'&email='+email+'&website='+website+'&branchname='+branchname+'&post='+post+'&doj='+doj+'&noa='+noa+'&noj='+noj+'" class="updatebtn">Update Information</a></td></tr>').insertAfter(document.getElementById("srow"+employeeid+"d"));
        $('<tr id="srow'+employeeid+'f" style="border-bottom: 1px solid black;"><td></td><td></td><td class="btn"><a href="javascript:;" p1="'+employeeid+'" class="showexp" id="vexp'+employeeid+'">View Experience</a></td><td class="btn"><a href="javascript:;" p1="'+employeeid+'" class="showqual" id="vqual'+employeeid+'">View Qualifications</a></td><td class="btn"><a href="javascript:;" p1="'+employeeid+'" class="showkr" id="vkr'+employeeid+'">View Knowledge Repository</a></td></tr>').insertAfter(document.getElementById("srow"+employeeid+"e"));
	
	});
	
	$("#studentprofile").on("click", ".showqual", function(e) {
		
		
		var $this = $(this);
		$this.css('display','none');
        var employeeid= $this.attr('p1');
        $(document.getElementById("srow"+employeeid+"f")).css('border-bottom','none')
        $.ajax({
            type: "GET",
            url: "getemployeequal",                
            dataType: "json",
            data: {"employeeid":employeeid,"qual":'1'},
            success:function(data){
            	
            	if(data!=''){
            		
            		$('<tr><td colspan="5"><table class="qualtable"><tbody  id="qbody'+employeeid+'"></tbody></table></td></tr>').insertAfter(document.getElementById("srow"+employeeid+"f"));
            		$.each(data, function (i, item) {
            			if(i==0)
            			{
            				$(document.getElementById("qbody"+employeeid)).append("<tr><th colspan='8'>Qualifications</th></tr><tr><th>Qualification</th><th>Degree</th><th>Specialization</th><th>Institute</th><th>University</th><th>Passout Year</th><th>Percentage</th><th>Achievement</th></tr>");
            			}
            			$(document.getElementById("qbody"+employeeid)).append('<tr><td>'+item.qname+'</td><td>'+item.qdegree+'</td><td>'+item.qspecialization+'</td><td>'+item.qinstitute+'</td><td>'+item.quniversity+'</td><td>'+item.qpassyr+'</td><td>'+item.qper+'</td><td>'+item.qachievement+'</td></tr>');
        ...
        $.ajax({
            ...
            url: "getemployeequal",                
            dataType: "json",
            data: {"employeeid":employeeid,"qual":'2'},
            success:function(data){
            	
            	if(data!=''){
            		
            		$('<tr><td colspan="5"><table class="qualtable"><tbody  id="cbody'+employeeid+'"></tbody></table></td></tr>').insertAfter(document.getElementById("srow"+employeeid+"f"));
            		$.each(data, function (i, item) {
            			if(i==0)
            			{
            				$(document.getElementById("cbody"+employeeid)).append("<tr><th colspan='4'>Certifications</th></tr><tr><th>Coursename</th><th>Institute</th><th>Duration</th><th>Content</th></tr>");
            			}
            			$(document.getElementById("cbody"+employeeid)).append('<tr><td>'+item.ccoursename+'</td><td>'+item.cinstitute+'</td><td>'+item.cduration+'</td><td>'+item.ccontent+'</td></tr>');
...
$("#studentprofile").on("click", ".showkr", function(e) {
            ...
            success:function(data){
            	...
            	if(data!=''){
            		...
            		$.each(data, function (i, item) {
            				...
            				$(document.getElementById("qbody"+employeeid)).append('<tr><th colspan="2">Knowledge Repository</th></tr>');
            			
            			
            			$(document.getElementById("qbody"+employeeid)).append('<tr><td class="tdkr">Headline</td><td>'+item.headline+'</td></tr><tr><td class="tdkr">Category</td><td>'+item.krcategory+'</td></tr><tr><td class="tdkr">Publication</td><td>'+item.publication+'</td></tr><tr><td class="tdkr">Author</td><td>'+item.author+'</td></tr><tr><td class="tdkr">Date of Publication</td><td>'+item.krdate+'</td></tr><tr><td class="tdkr">URL</td><td>'+item.krurl+'</td></tr><tr><td class="tdkr">Download Article</td><td><a href="getkrarticle?krid='+item.krid+'">Article Document(Click to Download)</a></td></tr><tr><td class="tdkr">Keywords</td><td>'+item.keywords+'</td></tr><tr><td class="tdkr">Content</td><td>'+item.content+'</td></tr><tr><td class="tdkr">Notes</td><td>'+item.notes+'</td></tr><tr><td class="tdkr">Priority</td><td>'+item.priority+'</td></tr><tr><td class="tdkr">Guide</td><td>'+item.guide+'</td></tr><tr><td class="tdkr">Co-Guide</td><td>'+item.coguide+'</td></tr><tr><td class="tdkr">Teamsize</td><td>'+item.teamsize+'</td></tr>');
...
$("#studentprofile").on("click", ".showexp", function(e) {
        ...
        success:function(data){
        	...
        	if(data!=''){
        		...
        		$.each(data, function (i, item) {
        			if(i==0)
        			{
        				$(document.getElementById("qbody"+employeeid)).append("<tr><th colspan='8'>Experience Details</th></tr><tr><th>Sr. No.</th><th>Institute</th><th>URL</th><th>Designation</th><th>Job Profile</th><th>From Date</th><th>To Date</th><th>Achievement</th></tr>");
        			}
        			$(document.getElementById("qbody"+employeeid)).append('<tr><td>'+c+'<td><td>'+item.eorg+'</td><td>'+item.eurl+'</td><td>'+item.designation+'</td><td>'+item.jobprofile+'</td><td>'+item.fromDate+'</td><td>'+item.toDate+'</td><td>'+item.achievement+'</td></tr>');
        			c++;
        		});
        	}
