				...
				$.ajax({
	                ...
	                success:function(data){
	                	...
	                	if(data!=''){
		                    ...
		                    $("#studentprofile").append('<tr id="srow'+item.facultyId+'"><td class="photo"><img src="employeephotoservlet?employeeid='+item.facultyId+'"></td><td class="otherdetails"><p class="sname"><a href="viewemployee?employeeid='+item.facultyId+'" target="_blank">Name: '+item.sal+' '+item.fname+' '+item.mname+' '+item.lname+'</a></p><p class="sother" style="text-align:right;font-size:small"><a href="updateemployee?employeeid='+item.facultyId+'&action=1" target="_blank">Profile</a> | <a href="updateemployee?employeeid='+item.facultyId+'&action=2" target="_blank">Qualification</a> | <a href="updateemployee?employeeid='+item.facultyId+'&action=3" target="_blank">Experience</a> | <a href="updateemployee?employeeid='+item.facultyId+'&action=4" target="_blank">Knowledge Repository</a></p><p class="sother">Branch: '+item.branchName+'</p><p class="sother">Post: '+item.post+'&emsp;Date of Joining: '+doj+'</p><p class="sother">Nature of Joining: '+item.noj+'&emsp;Nature of Appintment : '+item.noa+'</p></td></tr>');
	                		});
	                	}
	                	else
	                	{
