    	...
    	<div id="movable">
       		<div id="contentliquid">
       			<div id="content">
       				...
       				<h2 style="text-align: center;font-size: large;text-decoration: underline;">Student Feedback about Campus</h2>	
       				<div id="block1">
						...
						<table class="info">
                            ...
                            <tr>
                                ...
                                <td>Coaching for sports/games</td>
                            ...
                            <tr>
                                ...
                                <td>Cleanness of the class rooms</td>
                            ...
                            <tr>
                                ...
                                <td>Activities for Girl Students</td>
                            ...
                            <tr>
                                ...
                                <td>Playground / indoor games facilities</td>
                            ...
                            <tr>
                                ...
                                <td>Facilities in ladies room(Only for girl students)</td>
                            ...
                            <tr>
                                ...
                                <td>Student welfare scheme adopted / arranged</td>
                             ...
                             <tr>
                                ...
                                <td>Facility of consumer stores</td>
                            ...
                            <tr>
                                ...
                                <td>Coaching for competitive exams</td>
                                <td style="text-align:center"><input type="radio" name="p12" id="p12a" class="p12" value="10" required></td>
                                <td style="text-align:center"><input type="radio" name="p12" id="p12b" class="p12" value="7" required></td>
                                <td style="text-align:center"><input type="radio" name="p12" id="p12c" class="p12" value="5" required></td>
                                <td style="text-align:center"><input type="radio" name="p12" id="p12d" class="p12" value="3" required></td>
                            </tr>
                             <tr>
