    	...
    	<div id="movable">
       		<div id="contentliquid">
       			<div id="content">
       				...
       				<h2 style="text-align: center;font-size: large;text-decoration: underline;">Student Feedback about Teachers</h2>	
       				<div id="block1">
  						...
  						<table> 
                            ...
                            <tr>
                                <td class="llabel">Paper(If any)</td>
								<td>
									<input type="text" name="paper" id="paper"  class="simpletext" placeholder="Paper if any"/>
                                </td>
							...
							<tr>
                                <td class="llabel">Teacher Name:</td>
								<td>
									<span>(Teacher Name)</span>
                                </td>
                                <td class="llabel">Enter Student PRN Number<span class="required">*</span></td>
								<td>
									<input type="text" name="prnno" id="prnno"  class="simpletext" placeholder="Enter PRN Number" required/>
                                </td>
							</tr>
							<tr>
						...
						<table class="info">
							<tr>
								<th colspan="6">Tick (&radic;) the appropriate box for grading the teacher where</th>
							</tr>
							<tr>
                            ...
                            <tr>
                                ...
                                <td>Teacher explains concepts that is easy to understand</td>
                            ...
                            <tr>
                                ...
                                <td>Interaction with student outside class/lecture</td>
                            ...
                            <tr>
                                ...
                                <td>Use of ICT/ Computer/ Charts/ Models etc.</td>
                            ...
                            <tr>
                                ...
                                <td>Knowledge of subject/ Depth of subject</td>
                            ...
                            <tr>
                                ...
                                <td>Stimulating interest in subject</td>
                            ...
                            <tr>
                                ...
                                <td>Helfful in solving difficulties</td>
                            ...
                            <tr>
                                ...
                                <td>Use of appropriate teaching technique to enhance learning</td>
                            ...
                            <tr>
                                ...
                                <td>Frequent revision of syllabus</td>
                             ...
                             <tr>
                                ...
                                <td>Regularity of teacher in class</td>
                                <td style="text-align:center"><input type="radio" name="p11" id="p11a" class="p11" value="10" required></td>
                                <td style="text-align:center"><input type="radio" name="p11" id="p11b" class="p11" value="7" required></td>
                                <td style="text-align:center"><input type="radio" name="p11" id="p11c" class="p11" value="5" required></td>
                                <td style="text-align:center"><input type="radio" name="p11" id="p11d" class="p11" value="3" required></td>
                            </tr>
                            <tr>
