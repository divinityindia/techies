...
<c:if test = "${right.updatestudent==false}">
       		...
       		<div id="contentliquid">
       			<div id="content">
       				...
       				<div id="block1">
  						...
  						<form action="updatestudent" method="post" id="form1" enctype="multipart/form-data">
  						<table> 
							...
							<tr>
								...
								<td>
									<input type="text" class="simpletext" placeholder="mm/dd/yyyy" name="dateofbirth" id="datepicker-1" required="required" readonly="readonly">
								</td>
							...
							<tr>
								...
								<td>
									<input type="radio" name="gender" value="male" style="display: inline" required="required" id="male"/>Male
                                    <input type="radio" name="gender" value="female" style="display: inline" required="required" id="female"/>Female
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input type="text" class="simpletext" placeholder="mm/dd/yyyy" name="dateofadmission" id="datepicker-2" required="required" readonly="readonly">
								</td>
							</tr>
							...
							<!-- <tr>
								<td class="llabel">Guardian Photo</td>
								<td>
									<img id="gphoto" src=""/>
								</td>
							</tr> -->
							<tr>
								<td colspan="4" style="text-align: center;"><button type="submit" id="submitbtn">Update Data</button>&nbsp;&nbsp;&nbsp;<button type="reset" id="reset">Reset</button></td>
							</tr>
						</table>
						</form>
  						</div>
	...
	$.urlParam = function(name){
		...
		{
			$("#success").empty();
			$("#success").append('Student updated Successfully.');
		}
		else if($.urlParam('success')=='0')
		{
			$("#success").empty();
			$("#success").append('Student update failed...Please try again');
		}
		if($.urlParam('psuccess')=='1')
		{
			$("#success").append('<br>Parent updated Successfully.');
			$("#success").css('display','block');
		}
		else if($.urlParam('psuccess')=='0')
		{
			$("#success").append('<br>Parent update failed');
			$("#success").css('display','block');
		}
