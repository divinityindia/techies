                	...
                	<div class="templatemo_left_section_box_top" >Welcome To Pune District Education Association ERP Portal</div>
                        <div class="site_content" style="width: 950px;padding: 10px">
                            <fieldset>
								...
								<legend>
								Madhyamic Teaching Staff
								</legend>
								<table style="border: none" >
									<tr>
										<td width="200px">Select the Post</td>
										<TD><select style="width: 200px"></select></TD>
										<td rowspan="3">
											<div style="border: 1px solid #AAA;height: 50px;width: 150px; text-align: left">
												<input type="checkbox" /> Sample A<br/>
												<input type="checkbox" /> Sample B
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<tr><td></td><td></td>
										<td>
											<div style="border: 1px solid #AAA;height: 70px;width: 150px; text-align: left">
												<input type="radio" name="a"/> Grant<br/>
												<input type="radio" name="a" /> Non Grant<br/>
												<input type="radio" name="a" /> Working as Non Grant
											</div>
										</td>
									</tr>
								</table>
