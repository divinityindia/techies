                	...
                	<div class="templatemo_left_section_box_top" >Welcome To Pune District Education Association ERP Portal</div>
                        <div class="site_content" style="width: 950px;padding: 10px">
                            <fieldset>
								...
								<legend>
								Seniority List for Junior Colleges
								</legend>
								<table style="border: none" >
									<tr>
										<td width="200px">Select Post</td>
										<TD><select style="width: 200px"></select></TD>
									</tr>
									<tr>
										<td>SUBJECT</td>
										<TD><select style="width: 200px"></select></TD>
										<td style="padding-left: 70px"> <input type="checkbox" />Category Wise </td>
									</tr>
									<tr>
										<td>OPTIONS</td>
										<TD><select style="width: 200px"></select></TD>
								...
								<BR/><BR/><BR/><BR/>
									...
									Higher Secondary School / Jr.College Name <br/>
