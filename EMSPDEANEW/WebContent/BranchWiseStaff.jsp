                	...
                	<div class="templatemo_left_section_box_top" >Welcome To Pune District Education Association ERP Portal</div>
                        <div class="site_content" style="width: 950px;padding: 10px">
                            <fieldset>
								...
								<legend>
								School / College Display Record
								</legend>
									SELECT THE SCHOOL OR COLLEGE NAME / CODE <br/>
									<select style="width: 500px;">
									</select>
									<br/><br/><br/>
									<input type="checkbox" />Over Stay Report<br/>
									Over Stay in Branch Above Years <input type="number" style="width: 25px"/>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="checkbox" /> Designation Wise.
							</fieldset>
