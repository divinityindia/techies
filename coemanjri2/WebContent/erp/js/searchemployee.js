$(document).ready(function(){
	...
	$("#studentprofile").on("click", ".profile", function(e) {
        ...
        var eorg= $this.attr('p29');
        var eurl= $this.attr('p30');
        var designation= $this.attr('p31');
        var jobprofile= $this.attr('p32');
        var fromdate= $this.attr('p33');
        var todate = $this.attr('p34');
        var achievement = $this.attr('p35');
        var sal=$this.attr('p36');
        ...
        $(document.getElementById("srow"+employeeid+"g")).remove();
        ...
        $('<tr id="srow'+employeeid+'e"><td></td><td class="otherdetails"><h4>Previous Organization</h4> '+eorg+'<br>Website: '+eurl+'</td><td class="otherdetails"><h4>Designation</h4> '+designation+'<br>Job Profile: '+jobprofile+'</td><td class="otherdetails"><h4>From Date</h4> '+fromdate+'</td><td class="otherdetails"><h4>To Date</h4> '+todate+'</td></tr>').insertAfter(document.getElementById("srow"+employeeid+"d"));
        $('<tr id="srow'+employeeid+'f"><td></td><td class="otherdetails"><h4>Achievement</h4> '+achievement+'</td><td class="otherdetails"></td><td class="otherdetails"></td><td class="otherdetails"></td></tr>').insertAfter(document.getElementById("srow"+employeeid+"e"));
        $('<tr id="srow'+employeeid+'g" style="border-bottom: 1px solid black;"><td></td><td></td><td></td><td></td><td class="btn"><a href="editemployee.jsp?employeeid='+employeeid+'&sal='+sal+'&fname='+fname+'&mname='+mname+'&lname='+lname+'&panno='+panno+'&aadharno='+aadharno+'&paddress='+paddress+'&caddress='+caddress+'&pstate="'+pstate+'&cstate='+cstate+'&pcity='+pcity+'&ccity='+ccity+'&ppin='+ppin+'&cpin='+cpin+'&dob='+dob+'&gender='+gender+'&religion='+religion+'&category='+category+'&caste='+caste+'&mstatus='+mstatus+'&mobile="'+mobile+'&email='+email+'&website='+website+'&branchname='+branchname+'&post='+post+'&doj='+doj+'&noa='+noa+'&noj='+noj+'&eorg='+eorg+'&eurl='+eurl+'&designation='+designation+'&jobprofile='+jobprofile+'&fromdate='+fromdate+'&todate='+todate+'&achievement='+achievement+'" class="updatebtn">Update Information</a></td></tr>').insertAfter(document.getElementById("srow"+employeeid+"f"));
