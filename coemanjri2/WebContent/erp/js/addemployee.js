$(document).ready(function(){
	...
	$(function(){
		...
		{
			$("#success").empty();
			$("#success").append('Employee added Successfully. Fill other details of the Same Employee');
		...
		{
			$("#success").empty();
			$("#success").append('Employee add failed..Try again');
			$("#success").css('display','block');
		...
		if($.urlParam('krsuccess')=='1')
		{
			...
			$("#krsuccess").empty();
			$("#krsuccess").append('Record added to Knowledge Repository.');
