...
$(document).ready(function(){
	...
	$(".fid").val($.urlParam('employeeid').replace(/%20/g, " "));
	$("#salutation option:contains(" + $.urlParam('sal').replace(/%20/g, " ") +")").attr("selected", true);
	$("#fname").val($.urlParam('fname').replace(/%20/g, " "));
	$("#mname").val($.urlParam('mname').replace(/%20/g, " "));
	$("#lname").val($.urlParam('lname').replace(/%20/g, " "));
