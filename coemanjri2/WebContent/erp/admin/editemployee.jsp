  					...
  					<div id="block1">
  						...
  						<table> 
							...
							<tr>
								...
								<td>
									<input type="text" class="simpletext" placeholder="mm/dd/yyyy" name="dob" id="datepicker-1" required="required" readonly="readonly">
								</td>
							...
							<tr>
								<td class="llabel">Appointed for Branch<span class="required">*</span></td>
								<td>
							...
							<tr>
								...
								<td>
									<input type="text" class="simpletext" placeholder="mm/dd/yyyy" name="doj" id="datepicker-2" required="required" readonly="readonly">
								</td>
