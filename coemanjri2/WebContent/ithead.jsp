...
<html>
<head>
<title>:: HOD - Information Technology</title>
<meta charset="utf-8">
    ...
    <main class="container clear"> 
      ...
      <div class="group btmspace-30"> 
        ...
        <div class="one_half1" > 
          ...
          <img src="images/demo/120x120.gif"/>
          
          <div style="float: right; margin:0;">
          <h2></h2>
          <b>Prof. *** ***</b>
          <p>(Ph.D., M.E. Information Technology)</p>
          <h2></h2>
          <p style="font-style: italic;">Head of Department</p>
          <p style="font-style: italic;">Information Technology</p>
         </div>
          <p style="text-align: justify;">Information technology is a growing field that offers relatively secure positions for those with solid technical skills and at least a bachelor's degree in an IT-related field. From support to engineering, there are several specializations that deal with the various facets of information technology.</p>
           
		  <p style="text-align: justify;">The field of information technology (IT) covers the design, administration and support of computer and telecommunications systems. Some of the positions in this field include database and network administrators, computer support specialists, computer scientists, software programmers and system analysts. The majority of career tracks in IT entail design and operational tasks related to computer hardware components, networks and software applications.</p>           
          <!-- ################################################################################################ --> 
        </div>
