                    ...
                    <div class="row">
                   		<form  class="form-horizontal m-t-20" action="editselectedstudent" method="post" enctype="multipart/form-data">                  
               				<div>
                            	<div class="row">
                                	<div class="formitem">
                                    	<input type="hidden" name="studentid" id="studentid" value="<%=sb.getStudentid()%>"/>
                                   	...
                                   	<div class="formitem">
                                        ...
                                        <input type="text" class="form-control" name="prnno" maxlength="9" pattern="^[0-9]{8}[a-zA-Z]$" placeholder="Enter PRN no" value="<%=sb.getPrnno()%>" id="prnno" autocomplete="off"/>
                              		...
                              		<div class="formitem">
                                   		<h5><b>Date of Birth: <font color="tomato">*</font></b></h5>
                                        	<div class="input-group">
                                            	<input type="text" class="form-control" placeholder="mm/dd/yyyy" name="dateofbirth" id="datepicker-1" required="required" value=<%=text %>>
                              		...
                              		<div class="formitem">
                                   	...
                                   	<div class="formitem">
                                        ...
                                        <select class="form-control"  name="category" id="ecategory" required="required">
                                        	...
                                        	<option <% if(sb.getCategory().equals("General/OPEN")){%>selected<%} %>>General/OPEN</option>
                                        	<option <% if(sb.getCategory().equals("J & K Migrant")){%>selected<%} %>>J & K Migrant</option>
                                        	<option <% if(sb.getCategory().equals("Lingayat Vani")){%>selected<%} %>>Lingayat Vani</option>
                                        	<option <% if(sb.getCategory().equals("Maratha")){%>selected<%} %>>Maratha</option>
                                        	<option <% if(sb.getCategory().equals("NT")){%>selected<%} %>>NT</option>
                                        	<option <% if(sb.getCategory().equals("NT-1")){%>selected<%} %>>NT-1</option>
                                        	<option <% if(sb.getCategory().equals("NT-1(NT-D)")){%>selected<%} %>>NT-1(NT-D)</option>
                                        	<option <% if(sb.getCategory().equals("NT-2")){%>selected<%} %>>NT-2</option>
                                        	<option <% if(sb.getCategory().equals("NT-2(NT-C)")){%>selected<%} %>>NT-2(NT-C)</option>
                                        	<option <% if(sb.getCategory().equals("NT-2(NT-D)")){%>selected<%} %>>NT-2(NT-D)</option>
                                        	<option <% if(sb.getCategory().equals("NT-A")){%>selected<%} %>>NT-A</option>
                                        	<option <% if(sb.getCategory().equals("NT-B")){%>selected<%} %>>NT-B</option>
                                        	<option <% if(sb.getCategory().equals("NT-C")){%>selected<%} %>>NT-C</option>
                                        	<option <% if(sb.getCategory().equals("NT-D")){%>selected<%} %>>NT-D</option>
                                        	<option <% if(sb.getCategory().equals("OBC")){%>selected<%} %>>OBC</option>
                                        	<option <% if(sb.getCategory().equals("Raghuvanshi")){%>selected<%} %>>Raghuvanshi</option>
                                        	<option <% if(sb.getCategory().equals("SC")){%>selected<%} %>>SC</option>
                                        	<option <% if(sb.getCategory().equals("ST")){%>selected<%} %>>ST</option>
                                        	<option <% if(sb.getCategory().equals("SBC")){%>selected<%} %>>SBC</option>
                                        	<option <% if(sb.getCategory().equals("VJ")){%>selected<%} %>>VJ</option>
                                        	<option <% if(sb.getCategory().equals("VJ-NT")){%>selected<%} %>>VJ-NT</option>
                                        	<option <% if(sb.getCategory().equals("VJ-DT")){%>selected<%} %>>VJ-DT</option>
                                        </select>
                                  	</div> 
                             	...
                             	<div class="row">
                             		<div class="formitem">
                                        ...
                                        <input type="text" class="form-control" name="phone"  maxlength="10" pattern="[0-9]{10}" placeholder="Enter Phone no.(Only Numbers [0-9])" value="<%=sb.getPhone()%>" id="phone" required="required" title="Please Enter 10 digit valid Mobile Number"/>
                                  	</div>
                              		<div class="formitem">
                                ...
                                <div class="row">
                                  	<div class="formitem">
                                  		<input type="hidden" name="estate" id="estate" value="<%=sb.getState()%>"/>
                              		...
                              		<div class="formitem">
                                    	<input type="hidden" name="ecity" id="ecity" value="<%=sb.getCity()%>"/>
                             	...
                             	<div class="row">
                                   	<div class="formitem">
                                        ...
                                        <input type="text" class="form-control" name="pincode"  placeholder="Enter 6 digit pincode" maxlength="6" pattern="[0-9]{6}" id="pincode" required="required" value="<%=sb.getPincode()%>"/>
                                  	</div>
                                   	<div class="formitem">
                             	...
                             	<div class="row">
                                	<div class="formitem">
                              		...
                              		<div class="formitem">
                                        ...
                                        <input type="text" class="form-control" name="rollno"  pattern="[0-9]*" placeholder="Enter Roll no.(Only Numbers [0-9])" id="rollno" required="required" value="<%=sb.getRollno()%>"/>
                                  	</div>
                             	...
                             	<%
                               	...
                               	<div class="row">
                              		...
                              		<div class="formitem">
                                   		<h5><b>Admission Date: <font color="tomato">*</font></b></h5>
                                        	<div class="input-group">
                                            	<input type="text" class="form-control" placeholder="mm/dd/yyyy" name="dateofadmission" id="datepicker-2" required="required" value="<%=text%>">
                                                <span class="input-group-addon bg-custom b-0 text-white"><i class="icon-calender"></i></span>
                                            </div>
                                   	</div>
                              	...
                              	<button type="submit" class="btn btn-warning waves-effect waves-light w-lg" style="float: right;margin-top: 130px;height: 40px;" id="submitbtn">Save</button>
                          	</div>
                       	</form>
                    </div>
                </div>
