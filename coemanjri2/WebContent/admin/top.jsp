         ...
         <header id="topnav">
            <div class="topbar-main">
                <div class="container">
                    ...
                    <!-- Logo container-->
                    <div class="logo">
                        <a href="index.jsp" class="logo">PDEA's COLLEGE OF ENGINEERING, Manjari</a>
                    </div>
                    <!-- End Logo container-->
                    ...
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                                ...
                                <a href="admin.jsp"><i class="md md-dashboard"></i>HOME</a>
                              	<ul class="submenu">
                                    <li  class="has-submenu"><a href="#" class="waves-effect waves-light "><span>Student</span> </a>
                                    	<ul class="submenu">
                                    		<li><a href="addstudent" class="waves-effect waves-light "><span>Add Student</span> </a></li>
                                         	...
                                         	<li><a href="showstudentlist" class="waves-effect waves-light "> <span>Get All Students</span> </a></li>
                                    ...
                                    <li  class="has-submenu"><a href="#" class="waves-effect waves-light "> <span>Teacher</span> </a>
                                    	<ul class="submenu">
                                    		<li><a href="addfaculty" class="waves-effect waves-light "><span>Add Teacher</span></a></li>
                                    ...
                                    <li class="has-submenu"><a href="#" class="waves-effect waves-light "> <span>Routine</span></a>
                                    	<ul class="submenu">
                                    		<li><a href="routine" class="waves-effect waves-light "><span>Add Routines</span></a></li>
                                    		<li><a href="showroutines" class="waves-effect waves-light "> <span>Show Routines</span> </a></li>
                                		</ul>
                                    </li>
							...
							<li class="has-submenu">
                                ...
                                <ul class="submenu">
                                    <li><a href="addexam" class="waves-effect waves-light "> <span>Exam Master</span> </a></li>
                                    <li class="has-submenu"><a href="addexamschedule" class="waves-effect waves-light "><span>Exam Schedule</span> </a>
                                    	<ul class="submenu">
