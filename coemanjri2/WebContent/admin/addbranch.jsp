           ...
           <!-- Page-Title -->
        	...
        	<div class="row">
            	<div class="col-sm-12">
                    ...
                    <div class="row">
                   		<form  class="form-horizontal m-t-20" action="addbranch" method="post" id="form1">                  
               				<div>
                            	<div class="row">
                                	<div class="formitem">
                                	<input type="hidden" name="bid" id="bid" value=""/>
                                    	<h5><b>Branch Name: <font color="tomato">*</font></b></h5>
                                        <input type="text" class="form-control"  name="branchname" id="branchname"  placeholder="Enter Branch name" required="required" value=""/>
                                    </div>
                                    <div class="formitem">
                                ...
                                <div class="row">
                                	<div class="formitem">
                                    	...
                                    	<button type="submit" class="btn btn-warning waves-effect waves-light w-lg" style="margin-top: 20px;height: 40px;float: right;" id="addeditbutton">Add Branch</button>
                                    </div>
                                </div>
                             </div>
                       	</form>
                    ...
                    <div class="row">
                   		<form  class="form-horizontal m-t-20" action="addbranch" method="post" id="form2">                  
               				<div>
                            	<div class="row">
                                	<div class="formitem">
										...
										<table class="hovertable">
											<tr>
												<th>Branch ID</th><th>Branch Name</th><th>Delete Branch</th><th>Edit Branch</th>
											</tr>
										...
										<button type="submit" class="btn btn-warning waves-effect waves-light w-lg" style="margin-top: 20px;height: 40px;float: left;" id="deleteButton" disabled="disabled">Delete Branch</button>
