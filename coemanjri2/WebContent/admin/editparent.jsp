	...
	$("#student").change(function(event){
		...
		$.ajax({
			...
			success:function(data){
				...
				{
					$('#loading').hide();
					var editbutton=$("#editbutton").prop( "disabled", false );
				}
				else
				{
					$('#loading').hide();
					alert('Parent is not added for the selected Student');
					$("#student").prop("selectedIndex", 0)
					var editbutton=$("#editbutton").prop( "disabled", true );
				}
           ...
           <!-- Page-Title -->
        	...
        	<div class="row">
            	<div class="col-sm-12">
                    ...
                    <div class="row">
                   		<form class="form-horizontal m-t-20" action="editparent" method="post">                  
               				<div>
                            	<div class="row">
                               		<div class="formitem">
                             	...
                             	<div class="row">
                              	...
                              	<button type="submit" class="btn btn-warning waves-effect waves-light w-lg" style="float: right;margin-top: 130px;height: 40px;" disabled="disabled" id="editbutton">Edit Parent of Selected Student</button>
