...
public class EditSelectedTeacher extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EditSelectedTeacher() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	        ...
	        request.setAttribute("selectedclass",teacherBean.getClassId()+"");
	        request.getRequestDispatcher("editselectedteacher.jsp").forward(request, response);
		} catch (Exception e) {
			e.printStackTrace();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        while (iterator.hasNext()) {
        	...
        	HttpSession session=request.getSession();
        	TeacherBean tb=(TeacherBean)session.getAttribute("teacherBean");
            ...
            teacherBean.setTeacherid(tb.getTeacherid());
            ...
            int result = AddTeacherDao.updateTeacher(teacherBean,fields.get("changephoto"));
    		if(result==1)
    		{
    			response.sendRedirect("editteacher?success=1");
    		}
    		else
    		{
    			response.sendRedirect("editteacher?success=0");
    		}
