 ...
 */
public class AddFacultyQual extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AddFacultyQual() {
        super();
		...
		if(session.getAttribute("cat")!=null)
		{
			if(session.getAttribute("cat").equals("admin"))
			{
				...
				ArrayList<HashMap<String, String>> cert=new ArrayList<>();
					...
					System.out.println(request.getParameter("uspl"));
					...
					System.out.println(request.getParameter("crsname1"));
					...
					int result1[]=FacultyDao.addQual(qual);
					int result2[]=FacultyDao.addCert(cert);
					...
					response.sendRedirect("addteacher?qualsuccess="+qualsuccess+"&certsuccess="+certsuccess);
